...
[pt_x, pt_y] = getKeypoints(im_g3{1,1}, tau);    % Prob 1.1: keypoint detection
...
figure(3), imagesc(im{2}), hold off, axis image, colormap gray
hold on, plot(track_x', track_y', 'r');
figure(4), imagesc(im{3}), hold off, axis image, colormap gray
hold on, plot(track_x', track_y', 'r');
figure(5), imagesc(im{4}), hold off, axis image, colormap gray
hold on, plot(track_x', track_y', 'r');
figure(6), imagesc(im{5}), hold off, axis image, colormap gray
hold on, plot(track_x', track_y', 'r');
figure(7), imagesc(im{end}), hold off, axis image, colormap gray
hold on, plot(track_x', track_y', 'r');
