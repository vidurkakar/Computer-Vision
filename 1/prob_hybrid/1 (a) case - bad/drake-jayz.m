...
image1 = im2single(imread('data/drake.jpg'));
image2 = im2single(imread('data/jayz.jpg'));
...
%low_frequencies = 
low_frequencies = imfilter(image1,fspecial('gaussian',[14 14], cutoff_frequency));
...
%high_frequencies = 
high_frequencies = imfilter(image2,fspecial('gaussian',[14 14], cutoff_frequency));
