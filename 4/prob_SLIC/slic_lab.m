...
for iter = 1: numIter
    ...
    for i=1:size(cluster_center,1)
       ...
       %For dealing with cases of patches after the last patch.
       ...
       %For dealing with cases of patches before the first patch. 
       ...
       if y_patch_first < 1
        ...
        %Calculating distanes of pixel from cluster centres and updating
        %the cluser centre values
